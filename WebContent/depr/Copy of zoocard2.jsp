...
function generateHandCell(cardindex, player){
	...
	boardhtml+="<div class=\"select_card_button\" id=\"card_index_"+cardindex+"\" style=\"background-color: white; z-index:3;\">"+displayname+"</div></td>";
...
function saveHand(){
	par_score = p1_score - par;
	 ...
	 if(p1_score > p2_score){
		...
		var saveurl = 'MetaServer?dataset=zoo&command=savehand&features='+features+'&player_name='+player_name+'&score='+par_score+'&cv_accuracy='+p1_score+'&board_id='+seed+"&game=training_verse_barney&win="+win;
...
<body>
	...
	<div>
		<div id="board"
			style="left: 180px; position: absolute; top: 300px; width: 300px;">
