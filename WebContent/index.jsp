        ...
        <div id="main">
          ...
          <div id="sections" class="section">
            ...
            <div id="faq" style="display: none;">
              ...
              This approach, while it may seem strange for a scientific project, follows the 'publish then filter' approach that has made the Web so successful.  We hope that it encourages many people to share their time and their intelligence with the project.</p>
              </li>
              </ol>
              </div>
  ...
  $(document).ready(function() {
      ...
      $.getJSON(url, function(data) {
        ...
        function handleContentDisplay() {
          ...
          $.each( $("#column1 h3") , function(i,v) {
            $(v).toggle(function() {
                var selEl = $(this).attr('class').split(' ')[0];
                $("#column1 #"+selEl).slideDown();
              }, function() {
                 var selEl = $(this).attr('class').split(' ')[0];
                $("#column1 #"+selEl).slideUp();
              })
